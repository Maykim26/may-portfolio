...
const Intro = () => {
  ...
  useEffect(() => {
    ...
    const splitLines = text => {
      ...
      return lines.map((line, index) => (
        <div key={index} className="text-line">
          {splitLetters(line)} {/* 각 줄의 문자를 분리하여 애니메이션 적용 */}
        </div>
      ));
    };
    ...
    const animateLetters = () => {
      ...
      const sectionTrigger = document.querySelector('.intro__inner');
      ...
      letterElements.forEach(letter => {
        gsap.fromTo(
          ...
          },
          {
            ...
            y: gsap.utils.random(-1100, 500), // 시작 위치 Y
            rotation: gsap.utils.random(-138, 187), // 회전 시작값
            duration: 5.5,
            ...
            scrollTrigger: {
              ...
              toggleActions: 'restart none reverse none', // 섹션을 벗어나면 원위치로 돌아오도록 설정
            },
          },
        );
      });
