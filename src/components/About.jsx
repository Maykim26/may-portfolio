        ...
        <section id="about">
            <div className="content content-facilities half-half about__inner">
                <div className="row title-text-row">
                    ...
                    <div className="half">
                        <div className="col ">
                            <span className="txt-t2 ">{aboutText.intro}</span>{" "}
                            <br></br>
                    ...
                    <div className="half col">
                        <div className="row row-sets">
                            ...
                            <div className="row">
                                ...
                                <div className="col">
                                    <span className="txt-subtitle-4">
                                        {aboutText.shuttleTitle}
                                    </span>
                                    <div className="row txt-b3">
                                        <span>
                                            {aboutText.shuttleDescription}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a
                            className="link-btn"
                            href="https://heather-cornflower-534.notion.site/15f83b89399780a1a270e8f2e2be62c0"
                        >
